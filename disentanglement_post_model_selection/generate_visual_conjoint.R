...
x$cmdx <- paste0("                save_image(self.model.decoder(torch.tensor([[",x$x1,",",x$x2,",",x$x3,",",x$x4,",",x$x5,",",x$x6,",",x$x7,",",x$x8,",",x$x9,",",x$x10,"]]).to(self.device)).cpu(),self.experiment_name + 'x1_",x$v1,"_x2_",x$v2,"_x3_",x$v3,"_x4_",x$v4,"_x5_",x$v5,"_x6_",x$v6,"_x7_",x$v7,"_x8_",x$v8,"_x9_",x$v9,"_x10_",x$v10,".jpg') # Jun 15 2022")


# write.csv(x,"jun15_2022.csv",row.names = FALSE)

write.csv(x %>% select(cmdx),"save_text.txt",row.names=FALSE)
